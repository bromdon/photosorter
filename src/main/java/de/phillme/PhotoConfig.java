...
class PhotoConfig {
    ...
    PhotoConfig() {
        ...
        Option dateFormatEvents = new Option("dfe", true, "Events will be created with a folder name complying to this Java date format.");
        options.addOption(dateFormatEvents);

        Option dateFormatPhotos = new Option("dfp", true, "Photos will be renamed to a name complying to this Java date format.");
        ...
        Option noRename = new Option("n", "no-rename", false, "If this is set files will not be rename when moving.");
        options.addOption(noRename);
